...
P.sum_exp_trodes.params_N1f_N1s = [ "N1f_AP", ...
                                    ..."N1f_AP_gt0", ...
                                    ..."N1f_DV", ...
                                    "N1f_DV_gtn2", ...
                                    "N1f_ML", ...
                                    ...
                                    "k_age", ...
                                    "k_use"];
P.sum_exp_trodes.params_N1_a = [    "N1_AP", ...
                                    ..."N1f_AP_gt0", ...
                                    ..."N1f_DV", ...
                                    "N1_DV_gtn2", ...
                                    "N1_ML", ...
                                    ...
                                    "k_age", ...
                                    "k_use"];
P.sum_exp_trodes.params_orig = [    "N1_AP", ...
                                    "N1_ML", ...
                                    ...
                                    "k_AP", ...
                                    "k_DV_gtn2", ...
                                    "k_SO"];
P.sum_exp_trodes.orig_vs_elab_data_path = [P.data_folder_path filesep 'sum_exp_trodes_orig_vs_elab_data.mat'];
P.sum_exp_trodes.elab_mdl_CI_path = [P.data_folder_path filesep 'sum_exp_trodes_elab_mdl_CI.mat'];
%% plotting formats
