...
for i = 1:numel(Cells)
    ...
    switch rat_name
        ...
        case 'K265'
            ...
            Cells{i}.region_names(Cells{i}.DV <= -2.4 & ...
                                  Cells{i}.DV >  -5) = "dStr";
            Cells{i}.region_names(Cells{i}.DV <= -5) = "vStr";
            Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -2.4) = "MCtx";
            Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -2.4 & ...
                                           Cells{i}.electrodes.DV >  -5) = "dStr";
            Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -5) = "vStr";
        case 'T179'
        ...
        case 'A241'
            if Cells{i}.probe_serial=="18194823302"
                ...
                Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -2.5 & ...
                                               Cells{i}.electrodes.DV >  -5.3) = "dStr";
                Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -5.3 & ...
                                               Cells{i}.electrodes.DV >  -7.9) = "vStr";
        ...
        case 'A243'
            ...
            Cells{i}.electrodes.brain_area(Cells{i}.electrodes.DV <= -8.4) = "piriform";  
        case 'A249'
            Cells{i}.region_names(Cells{i}.DV >  -5.3) = "dStr";
            Cells{i}.region_names(Cells{i}.DV <= -5.3) = "vStr";
        otherwise
            error('Unknown rat')
    end
end