...
%% 
%   assume all violation trials have been removed
function Psych = fit_psychometric(pd)
    ...
    Psych = fit_logistic4(n_right-n_left, pd.pokedR);
end
%%
% make sure all fields have the same number of trials
% remove laser on trials
