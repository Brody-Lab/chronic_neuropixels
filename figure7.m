% FIGURE6 makes figure 7 from Luo*, Bondy* et al
%
...
%
%   Cells
%       A structure containing the neural recording data
%
%   from_scratch
...
if P_input.from_scratch
    ...
    if ~exist('Cells', 'var')
        fprintf('Loading the variable CELLS...')
        load([P.data_folder_path filesep 'Cells.mat']);
    end
    if ~exist('ChoiceMod', 'var')    
        fprintf('Loading the variable ChoiceMod...')        
...
for i = 1:numel(P.figure_image_format)
    saveas(gcf, [P.plots_folder_path filesep 'figure7'], P.figure_image_format{i})
end